...
def check(email):
    url = " https://heuu8w6nv9.execute-api.us-west-2.amazonaws.com/plasma/getdata?email="+email
...
def register():
    ...
    if('errorType' in check(x[1])):
        url = " https://heuu8w6nv9.execute-api.us-west-2.amazonaws.com/plasma/registration?"+params
...
@app.route('/stats')
def stats():
    url = " https://heuu8w6nv9.execute-api.us-west-2.amazonaws.com/plasma/getbloodgroupsdata"
    response = requests.get(url)
    r = response.json()
    print(r)
...
def requested():
    ...
    #print(bloodgrp)
    url = " https://heuu8w6nv9.execute-api.us-west-2.amazonaws.com/plasma/requestonbloodgroup?blood="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
    print(a)
    phone=[]
